...
def determine_section_Cl(W_times_chord_times_Cl, kvisc, alphas, airfoil, M, Cl_ini = 1):
    ...
    while tries < 20:
        ...
        alpha, Cl_new, Cd = calculate_most_eff_alpha(alpha_c, Cl_c, Cd_c)
...
def blade_design_vortex_v1_2(vi, radps, Blades, p, R, sections = 21, rho = 1.225, dvisc = 1.8/100000, Cl_ref = 1, a_ref = 5, Cd_ref = 0.01, Prescribed_power = 520, Prescribed_thrust = 50, init_disp = 0):
    #From Design of Optimum Propellers, Charles N. Adkins*, Falls Church, Virginia 22042 and Robert H. Liebeckt, Douglas Aircraft Company, Long Beach, California 90846
