...
for J in J_vec:
    ...
    radps = rps*2*pi
    #vi = J*rps*D
    dT_vector, dQ_vector, r_vector, Re_dist, WA_dist, Cl_dist, Cd_dist = simulate.fixed_pitch_qprop(vi, radps, Blades, p, R, Beta_vector, airfoil = airfoil, sections = sections, rho = rho, dvisc = dvisc)
