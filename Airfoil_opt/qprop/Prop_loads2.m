...
dQ_blade= dQr./4;                                                         %calculo da derivada do torque para uma pa
rR_vec = r_vector./R;

T = sum (dT);                                                            %Integrar todos os dT
Q = sum (dQ);                                                            %Integrar todos os dQ
plot(r_vector, dT_blade)


T = table(rR_vec, r_vector, dT_blade, dQ_blade);                                           %escrever no excel
