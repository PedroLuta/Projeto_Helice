...
def write_propfile_SI(info_dict, r_vec, chord_vec, beta_vec, propfile = "propfile_test.txt"):
    #This function considers only SI units
    name = info_dict["Name"]
    max_radius = info_dict["Max Radius"]
    Blades = info_dict["Blades"]
    Cl0 = info_dict["Cl0"]
    Cla = info_dict["Cla"]
    Clmin = info_dict["Clmin"]
    Clmax = info_dict["Clmax"]
    Cd0 = info_dict["Cd0"]
    Cd2u = info_dict["Cd2u"]
    Cd2l = info_dict["Cd2l"]
    ClCd0 = info_dict["ClCd0"]
    Re_ref = info_dict["Re_ref"]
    Re_exp = info_dict["Re_exp"]
